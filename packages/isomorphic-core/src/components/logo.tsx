...
export default function Logo({ iconOnly = false, ...props }: IconProps) {
  return (
    <img
      alt="File:Tata Motors Logo.svg"
      src="//upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Tata_Motors_Logo.svg/800px-Tata_Motors_Logo.svg.png"
      decoding="async"
      width="400"
      height="91"
      // srcset="//upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Tata_Motors_Logo.svg/1200px-Tata_Motors_Logo.svg.png 1.5x, //upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Tata_Motors_Logo.svg/1600px-Tata_Motors_Logo.svg.png 2x"
      data-file-width="1000"
      data-file-height="151"
    ></img>
    // <svg
