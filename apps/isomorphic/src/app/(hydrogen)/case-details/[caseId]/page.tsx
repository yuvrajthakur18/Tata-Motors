...
export default async function CaseDetailsPage({ params }: any) {
  ...
  return (
    <div>
      ...
      <BrandSentiment className="m-5 p-3" />
      ...
      <EmpathyAnalysisTable className="m-5 p-3" />
      ...
      <AgentPerformanceAnalysisTable className="m-5 p-3" />
      ...
      <AgentThreshold className="m-5 p-3" />
      ...
      <SuggestedCoachingTable className="m-5 p-3" />
      ...
      <PlanOfAction className="m-5 p-3" />
    </div>
  );
}
