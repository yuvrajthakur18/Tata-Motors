...
import { callNatureData, revenueSummaryData } from '@/data/crm-dashboard-data';
...
export default function CallNatureType({ className }: { className?: string }) {
  ...
  return (
    <WidgetCard
      ...
      description="Showing Call wise nature of the call"
    >
