...
import { empathyAnalysisData } from '@/data/empathy-analysis-data';
...
export type AppointmentDataType = (typeof empathyAnalysisData)[number];

export default function EmpathyAnalysisTable({
  className,
}: {
  className?: string;
}) {
  const { table, setData } = useTanStackTable<AppointmentDataType>({
    tableData: empathyAnalysisData,
