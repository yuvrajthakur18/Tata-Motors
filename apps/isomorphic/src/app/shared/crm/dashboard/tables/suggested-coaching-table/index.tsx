...
import { suggestedCoachingData } from '@/data/suggested-coaching-data';
...
export type AppointmentDataType = (typeof suggestedCoachingData)[number];
...
export default function SuggestedCoachingTable({
  ...
  const { table, setData } = useTanStackTable<AppointmentDataType>({
    tableData: suggestedCoachingData,
