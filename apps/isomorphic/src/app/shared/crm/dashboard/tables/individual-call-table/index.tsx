...
import { individualCallData } from '@/data/individual-call-data';
...
export type AppointmentDataType = (typeof individualCallData)[number];

export default function IndividualCallTable({
  className,
}: {
  className?: string;
}) {
  const { table, setData } = useTanStackTable<AppointmentDataType>({
    tableData: individualCallData,
