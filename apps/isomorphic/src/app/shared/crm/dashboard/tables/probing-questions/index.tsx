...
import { probingQuestionsColumns } from './columns';
import { probingQuestionsData } from '@/data/probing-questions-data';
...
export default function ProbingQuestions({
  ...
  const { table, setData } = useTanStackTable<ProbingQuestionsDataType>({
    tableData: probingQuestionsData,
    columnConfig: probingQuestionsColumns,
    options: {
      initialState: {
        pagination: {
          pageIndex: 0,
  ...
  return (
    <WidgetCard
      ...
      title="Probing Questions by the agents"
