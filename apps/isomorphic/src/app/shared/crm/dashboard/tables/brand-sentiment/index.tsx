...
import { brandSentimentData } from '@/data/brand-sentiment-data';
...
export type AppointmentDataType = (typeof brandSentimentData)[number];

export default function BrandSentimentTable({
  className,
}: {
  className?: string;
}) {
  const { table, setData } = useTanStackTable<AppointmentDataType>({
    tableData: brandSentimentData,
