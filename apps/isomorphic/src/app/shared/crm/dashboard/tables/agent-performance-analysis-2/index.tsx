...
import { agentPerformanceAnalysisData } from '@/data/agent-performance-data-2';
...
export type AppointmentDataType = (typeof agentPerformanceAnalysisData)[number];
...
export default function AgentPerformanceAnalysisTable({
  ...
  const { table, setData } = useTanStackTable<AppointmentDataType>({
    tableData: agentPerformanceAnalysisData,
